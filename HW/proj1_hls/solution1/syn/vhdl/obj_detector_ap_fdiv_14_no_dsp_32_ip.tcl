...
create_ip -name floating_point -version 7.0 -vendor xilinx.com -library ip -module_name obj_detector_ap_fdiv_14_no_dsp_32
# BEGIN Vivado Commands 
...
set_property -dict [list CONFIG.a_precision_type Single \
                          ...
                          CONFIG.component_name obj_detector_ap_fdiv_14_no_dsp_32 \
                          ...
                          CONFIG.result_tlast_behv Null] -objects [get_ips obj_detector_ap_fdiv_14_no_dsp_32] -quiet
# END Vivado Parameters
set_property generate_synth_checkpoint false [get_files obj_detector_ap_fdiv_14_no_dsp_32.xci]
generate_target {synthesis simulation} [get_files obj_detector_ap_fdiv_14_no_dsp_32.xci]
