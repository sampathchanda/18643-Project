...
architecture behav of obj_detector is 
    ...
    "obj_detector,hls_ip_2015_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=1,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=20.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=16.625000,HLS_SYN_LAT=36741,HLS_SYN_TPT=none,HLS_SYN_MEM=42,HLS_SYN_DSP=62,HLS_SYN_FF=17077,HLS_SYN_LUT=31469}";
