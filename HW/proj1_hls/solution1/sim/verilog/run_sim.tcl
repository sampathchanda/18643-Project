...
if {[file isfile obj_detector.autotvin.dat]} {
    file delete -force obj_detector.autotvin.dat
}
if {[file isfile obj_detector.autotvout.dat]} {
    file delete -force obj_detector.autotvout.dat
}
