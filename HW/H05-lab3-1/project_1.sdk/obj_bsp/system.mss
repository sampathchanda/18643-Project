...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = hier_bram_0_axi_cdma_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axicdma
 PARAMETER DRIVER_VER = 3.0
 PARAMETER HW_INSTANCE = hier_bram_1_axi_cdma_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axicdma
 PARAMETER DRIVER_VER = 3.0
 PARAMETER HW_INSTANCE = hier_bram_2_axi_cdma_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axicdma
 PARAMETER DRIVER_VER = 3.0
 PARAMETER HW_INSTANCE = hier_bram_3_axi_cdma_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = obj_detector
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = obj_detector_0
END
