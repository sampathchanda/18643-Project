...
#include "xaxicdma.h"
#include "xaxicdma_simple_poll_header.h"
#include "xdevcfg.h"
...
int main() 
{
...

   {
      ...
      print("\r\n Runnning XAxiCdma_SimplePollExample() for hier_bram_1_axi_cdma_0...\r\n");
      
      status = XAxiCdma_SimplePollExample(XPAR_HIER_BRAM_1_AXI_CDMA_0_DEVICE_ID);
...

   {
      ...
      print("\r\n Runnning XAxiCdma_SimplePollExample() for hier_bram_2_axi_cdma_0...\r\n");
      
      status = XAxiCdma_SimplePollExample(XPAR_HIER_BRAM_2_AXI_CDMA_0_DEVICE_ID);
...

   {
      ...
      print("\r\n Runnning XAxiCdma_SimplePollExample() for hier_bram_0_axi_cdma_0...\r\n");
      
      status = XAxiCdma_SimplePollExample(XPAR_HIER_BRAM_0_AXI_CDMA_0_DEVICE_ID);
