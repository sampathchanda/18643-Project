...
proc create_root_design { parentCell } {
  ...
  # Create instance: matrix_mult_1, and set properties
  set matrix_mult_1 [ create_bd_cell -type ip -vlnv xilinx.com:hls:matrix_mult:1.0 matrix_mult_1 ]
  ...
  connect_bd_intf_net -intf_net matrix_mult_1_a_PORTA [get_bd_intf_pins hier_bram_0/BRAM_PORTB] [get_bd_intf_pins matrix_mult_1/a_PORTA]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M01_AXI [get_bd_intf_pins matrix_mult_1/s_axi_control] [get_bd_intf_pins processing_system7_0_axi_periph/M01_AXI]
  ...
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins hier_bram_0/s_axi_lite_aresetn] [get_bd_pins hier_bram_1/s_axi_lite_aresetn] [get_bd_pins hier_bram_2/s_axi_lite_aresetn] [get_bd_pins matrix_mult_1/ap_rst_n] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M02_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M03_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn]
