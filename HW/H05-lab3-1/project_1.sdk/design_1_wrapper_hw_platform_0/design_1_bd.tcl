...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.PCW_USE_S_AXI_HP0 {1} CONFIG.PCW_USE_S_AXI_HP1 {1} CONFIG.PCW_USE_S_AXI_HP2 {1} CONFIG.preset {ZedBoard}  ] $processing_system7_0
  ...
  connect_bd_intf_net -intf_net matrix_mult_0_a_PORTA [get_bd_intf_pins hier_bram_0/BRAM_PORTB] [get_bd_intf_pins matrix_mult_0/a_PORTA]
  connect_bd_intf_net -intf_net matrix_mult_0_b_PORTA [get_bd_intf_pins hier_bram_1/BRAM_PORTB] [get_bd_intf_pins matrix_mult_0/b_PORTA]
  connect_bd_intf_net -intf_net matrix_mult_0_prod_PORTA [get_bd_intf_pins hier_bram_2/BRAM_PORTB] [get_bd_intf_pins matrix_mult_0/prod_PORTA]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M01_AXI [get_bd_intf_pins matrix_mult_0/s_axi_control] [get_bd_intf_pins processing_system7_0_axi_periph/M01_AXI]
  ...
  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins hier_bram_0/s_axi_lite_aclk] [get_bd_pins hier_bram_1/s_axi_lite_aclk] [get_bd_pins hier_bram_2/s_axi_lite_aclk] [get_bd_pins matrix_mult_0/ap_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP1_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP2_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/M02_ACLK] [get_bd_pins processing_system7_0_axi_periph/M03_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_0_100M/ext_reset_in]
  connect_bd_net -net rst_processing_system7_0_100M_interconnect_aresetn [get_bd_pins hier_bram_0/ARESETN] [get_bd_pins hier_bram_1/ARESETN] [get_bd_pins hier_bram_2/ARESETN] [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins rst_processing_system7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins hier_bram_0/s_axi_lite_aresetn] [get_bd_pins hier_bram_1/s_axi_lite_aresetn] [get_bd_pins hier_bram_2/s_axi_lite_aresetn] [get_bd_pins matrix_mult_0/ap_rst_n] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M02_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M03_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs matrix_mult_0/s_axi_control/Reg] SEG_matrix_mult_0_Reg
  create_bd_addr_seg -range 0x2000 -offset 0xC0000000 [get_bd_addr_spaces hier_bram_0/axi_cdma_0/Data] [get_bd_addr_segs hier_bram_0/axi_bram_ctrl_0/S_AXI/Mem0] SEG_axi_bram_ctrl_0_Mem0
