...
upvar ::AESL_AUTOSIM::DirAutoSimRoot  DirAutoSimRoot
    ...
    set gWorkingDir             "../.."
    set constFileTvIn           "splitter.autotvin.dat"
    set constFileTvOut          "splitter.autotvout.dat"
    set constFileHdlTvIn        "splitter.autohdltvin.dat"
    set constFileHdlTvOut       "splitter.autohdltvout.dat"
    set gGateLevelSim           "0"
    set gAutowrap               "1"
    set gTool                   "modelsim"
