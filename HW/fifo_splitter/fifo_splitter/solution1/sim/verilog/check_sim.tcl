...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.splitter.autotvin_input_V.dat"
         "c.splitter.autotvin_output_0_V.dat"
         "c.splitter.autotvin_output_1_V.dat"
         "c.splitter.autotvin_output_2_V.dat"
         "c.splitter.autotvin_output_3_V.dat"
         "c.splitter.autotvin_output_4_V.dat"
         "c.splitter.autotvin_output_5_V.dat"
         "c.splitter.autotvout_output_0_V.dat"
         "c.splitter.autotvout_output_1_V.dat"
         "c.splitter.autotvout_output_2_V.dat"
         "c.splitter.autotvout_output_3_V.dat"
         "c.splitter.autotvout_output_4_V.dat"
         "c.splitter.autotvout_output_5_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.splitter.autotvout_output_0_V.dat"
         "rtl.splitter.autotvout_output_1_V.dat"
         "rtl.splitter.autotvout_output_2_V.dat"
         "rtl.splitter.autotvout_output_3_V.dat"
         "rtl.splitter.autotvout_output_4_V.dat"
         "rtl.splitter.autotvout_output_5_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
