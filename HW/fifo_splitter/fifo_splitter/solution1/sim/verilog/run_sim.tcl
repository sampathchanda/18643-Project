...
if {[file isfile splitter.autotvin.dat]} {
    file delete -force splitter.autotvin.dat
}
if {[file isfile splitter.autotvout.dat]} {
    file delete -force splitter.autotvout.dat
}
