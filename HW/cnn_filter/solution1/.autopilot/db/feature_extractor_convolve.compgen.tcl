...
set id 1
set name feature_extractor_fadd_32ns_32ns_32_5_full_dsp
...
set id 2
set name feature_extractor_fmul_32ns_32ns_32_4_max_dsp
...
set id 3
set name feature_extractor_sitofp_32ns_32_6
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename B \
    op interface \
    ports { B_address0 { O 8 vector } B_ce0 { O 1 bit } B_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename conv \
    op interface \
    ports { conv_address0 { O 12 vector } conv_ce0 { O 1 bit } conv_we0 { O 1 bit } conv_d0 { O 32 vector } conv_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'conv'"
}
}
