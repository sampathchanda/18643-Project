set C_TypeInfoList {{ 
"feature_extractor" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"A": [[], {"array": [ {"array": [ {"scalar": "int"}, [28]]}, [28]]}] }, {"W": [[], {"array": [ {"array": [ {"scalar": "float"}, [5,5]]}, [6]]}] }, {"feature": [[], {"array": [ {"array": [ {"scalar": "int"}, [12,12]]}, [6]]}] }],[],""]
}}
...
set C_modelArgList { 
	{ A int 32 regular {array 784 { 1 3 } 1 1 }  }
	{ W float 32 regular {array 150 { 1 3 } 1 1 }  }
	{ feature int 32 regular {array 864 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "A", "interface" : "memory", "bitwidth" : 32 ,"direction" : "READONLY" ,"bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "A","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 27,"step" : 1},{"low" : 0,"up" : 27,"step" : 1}]}]}]} , 
 	{ "Name" : "W", "interface" : "memory", "bitwidth" : 32 ,"direction" : "READONLY" ,"bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "W","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 5,"step" : 1},{"low" : 0,"up" : 4,"step" : 1},{"low" : 0,"up" : 4,"step" : 1}]}]}]} , 
 	{ "Name" : "feature", "interface" : "memory", "bitwidth" : 32 ,"direction" : "WRITEONLY" ,"bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "feature","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 5,"step" : 1},{"low" : 0,"up" : 11,"step" : 1},{"low" : 0,"up" : 11,"step" : 1}]}]}]} ]}
...
set portList { 
	...
	{ feature_address0 sc_out sc_lv 10 signal 2 } 
...
set Spec2ImplPortList { 
	...
	feature { ap_memory {  { feature_address0 mem_address 1 10 }  { feature_ce0 mem_ce 1 1 }  { feature_we0 mem_we 1 1 }  { feature_d0 mem_din 1 32 } } }
}
