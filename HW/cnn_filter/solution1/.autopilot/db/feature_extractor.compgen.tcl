...
set id 16
set name feature_extractor_fpext_32ns_64_1
...
set id 17
set name feature_extractor_dexp_64ns_64ns_64_18_full_dsp
...
set id 18
set name feature_extractor_sdiv_3ns_32ns_32_7_seq
...
set ID 19
set MemName feature_extractor_C
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename W \
    op interface \
    ports { W_address0 { O 8 vector } W_ce0 { O 1 bit } W_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename feature \
    op interface \
    ports { feature_address0 { O 10 vector } feature_ce0 { O 1 bit } feature_we0 { O 1 bit } feature_d0 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'feature'"
}
}
