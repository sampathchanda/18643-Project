...
set C_modelArgList { 
	...
	{ B float 32 regular {array 150 { 1 3 } 1 1 }  }
	{ tmp int 3 regular  }
	{ conv float 32 regular {array 3456 { 2 3 } 1 1 }  }
	{ tmp1 int 3 regular  }
}
...
set Spec2ImplPortList { 
	...
	B { ap_memory {  { B_address0 mem_address 1 8 }  { B_ce0 mem_ce 1 1 }  { B_q0 mem_dout 0 32 } } }
	tmp { ap_none {  { tmp in_data 0 3 } } }
	conv { ap_memory {  { conv_address0 mem_address 1 12 }  { conv_ce0 mem_ce 1 1 }  { conv_we0 mem_we 1 1 }  { conv_d0 mem_din 1 32 }  { conv_q0 mem_dout 0 32 } } }
