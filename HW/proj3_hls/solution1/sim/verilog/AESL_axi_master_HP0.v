...
//------------------------Parameter----------------------
`define TV_IN_HP0 "../tv/cdatafile/c.obj_detector.autotvin_HP0.dat"
`define TV_OUT_HP0 "../tv/rtldatafile/rtl.obj_detector.autotvout_HP0.dat"
 parameter HP0_ADDR_BITWIDTH = 32'd 32;
 parameter HP0_AWUSER_BITWIDTH = 32'd 1;
 parameter HP0_DATA_BITWIDTH = 32'd 32;
 parameter HP0_WUSER_BITWIDTH = 32'd 1;
 parameter HP0_ID_BITWIDTH = 32'd 1;
 parameter HP0_RUSER_BITWIDTH = 32'd 1;
 parameter HP0_BUSER_BITWIDTH = 32'd 1;
 parameter   FIFO_DEPTH            =   32'd 32;
 parameter   mem_page_num            =   32'd 2;
 parameter   FIFO_DEPTH_ADDR_WIDTH   =    32'd 32;
parameter HP0_C_DATA_BITWIDTH = 32'd 32;
parameter HP0_mem_depth = 32'd 784;
parameter ReadReqLatency = 32'd 5;
parameter WriteReqLatency = 32'd 5;
// Input and Output
input clk;
input reset;
input  TRAN_HP0_AWVALID;
output  TRAN_HP0_AWREADY;
input [HP0_ADDR_BITWIDTH - 1 : 0] TRAN_HP0_AWADDR;
input [HP0_ID_BITWIDTH - 1 : 0] TRAN_HP0_AWID;
input [8 - 1 : 0] TRAN_HP0_AWLEN;
input [3 - 1 : 0] TRAN_HP0_AWSIZE;
input [2 - 1 : 0] TRAN_HP0_AWBURST;
input [2 - 1 : 0] TRAN_HP0_AWLOCK;
input [4 - 1 : 0] TRAN_HP0_AWCACHE;
input [3 - 1 : 0] TRAN_HP0_AWPROT;
input [4 - 1 : 0] TRAN_HP0_AWQOS;
input [4 - 1 : 0] TRAN_HP0_AWREGION;
input [HP0_AWUSER_BITWIDTH - 1 : 0] TRAN_HP0_AWUSER;
input  TRAN_HP0_WVALID;
output  TRAN_HP0_WREADY;
input [HP0_DATA_BITWIDTH - 1 : 0] TRAN_HP0_WDATA;
input [HP0_DATA_BITWIDTH/8 - 1 : 0] TRAN_HP0_WSTRB;
input  TRAN_HP0_WLAST;
input  TRAN_HP0_WID;
input [HP0_WUSER_BITWIDTH - 1 : 0] TRAN_HP0_WUSER;
input  TRAN_HP0_ARVALID;
output  TRAN_HP0_ARREADY;
input [HP0_ADDR_BITWIDTH - 1 : 0] TRAN_HP0_ARADDR;
input [HP0_ID_BITWIDTH - 1 : 0] TRAN_HP0_ARID;
input [8 - 1 : 0] TRAN_HP0_ARLEN;
input [3 - 1 : 0] TRAN_HP0_ARSIZE;
input [2 - 1 : 0] TRAN_HP0_ARBURST;
input [2 - 1 : 0] TRAN_HP0_ARLOCK;
input [4 - 1 : 0] TRAN_HP0_ARCACHE;
input [3 - 1 : 0] TRAN_HP0_ARPROT;
input [4 - 1 : 0] TRAN_HP0_ARQOS;
input [4 - 1 : 0] TRAN_HP0_ARREGION;
input  TRAN_HP0_ARUSER;
output  TRAN_HP0_RVALID;
input  TRAN_HP0_RREADY;
output [HP0_DATA_BITWIDTH - 1 : 0] TRAN_HP0_RDATA;
output  TRAN_HP0_RLAST;
output [HP0_ID_BITWIDTH - 1 : 0] TRAN_HP0_RID;
output [HP0_RUSER_BITWIDTH - 1 : 0] TRAN_HP0_RUSER;
output [2 - 1 : 0] TRAN_HP0_RRESP;
output  TRAN_HP0_BVALID;
input  TRAN_HP0_BREADY;
output [2 - 1 : 0] TRAN_HP0_BRESP;
output [HP0_ID_BITWIDTH - 1 : 0] TRAN_HP0_BID;
output [HP0_BUSER_BITWIDTH - 1 : 0] TRAN_HP0_BUSER;
output [32 - 1 : 0] TRAN_HP0_A;
input ready;
input done;

// Inner signals
// AW request fifo
reg    [HP0_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [HP0_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR_tmp; 
...
// AR request fifo
reg    [HP0_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [HP0_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR_tmp; 
...
// WDATA fifo
reg    [HP0_DATA_BITWIDTH - 1 : 0]         FIFO_WDATA           [0 : FIFO_DEPTH - 1]; 
reg    [HP0_DATA_BITWIDTH/8 - 1 : 0]       FIFO_WSTRB           [0 : FIFO_DEPTH - 1]; 
...
reg [HP0_DATA_BITWIDTH - 1:0] RDATA_tmp = 0;
reg [2 - 1:0] RRESP_tmp = 0;
reg RLAST_tmp = 0;
reg RVALID_tmp = 0;
reg [32 - 1 : 0] A = 0;
reg [HP0_DATA_BITWIDTH - 1 : 0] HP0_mem [0 : HP0_mem_depth * mem_page_num  - 1]; 
reg [31 : 0] clk_counter ;
reg [31 : 0] current_AW_req_transaction = 0 ;
reg [31 : 0] current_AR_req_transaction = -1 ;

assign TRAN_HP0_AWREADY    =    !FIFO_AW_req_full; 
assign TRAN_HP0_ARREADY    =    !FIFO_AR_req_full; 
assign TRAN_HP0_WREADY    =     !(FIFO_WDATA_req_full || FIFO_WDATA_size_full); 
assign TRAN_HP0_BVALID = (BRESP_counter == 0) ? 0 : 1;
assign TRAN_HP0_BRESP = BRESP_tmp;
assign TRAN_HP0_RDATA = RDATA_tmp;
assign TRAN_HP0_RRESP = RRESP_tmp;
assign TRAN_HP0_RLAST = RLAST_tmp;
assign TRAN_HP0_RVALID = RVALID_tmp;
assign    TRAN_HP0_A = A;
...
initial begin : initialize_offset
  ...
  integer c_bitwidth;
  DATA_byte_num = 0; 
  c_bitwidth = HP0_C_DATA_BITWIDTH;
  count_c_data_byte_num_by_bitwidth (c_bitwidth , DATA_byte_num);
  A <= 0 * DATA_byte_num;
end

initial begin : initialize_HP0_mem
  integer i;
  for (i = 0; i < HP0_mem_depth * mem_page_num; i = i + 1) begin
      HP0_mem[i] = 0;
  end
end
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_HP0_AWREADY & TRAN_HP0_AWVALID ) begin    // RTL is sending a AW_request to the bus         
            FIFO_AW_req_SIZE [FIFO_AW_req_ptr_w]    =   TRAN_HP0_AWSIZE; 
            FIFO_AW_req_ADDR [FIFO_AW_req_ptr_w]    =   TRAN_HP0_AWADDR; 
            FIFO_AW_req_LEN  [FIFO_AW_req_ptr_w]    =   TRAN_HP0_AWLEN; 
            FIFO_AW_req_BURST[FIFO_AW_req_ptr_w]    =   TRAN_HP0_AWBURST; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_HP0_ARREADY & TRAN_HP0_ARVALID ) begin    // RTL is sending a AR_request to the bus         
            FIFO_AR_req_SIZE [FIFO_AR_req_ptr_w]    =   TRAN_HP0_ARSIZE; 
            FIFO_AR_req_ADDR [FIFO_AR_req_ptr_w]    =   TRAN_HP0_ARADDR; 
            FIFO_AR_req_LEN  [FIFO_AR_req_ptr_w]    =   TRAN_HP0_ARLEN; 
            FIFO_AR_req_BURST[FIFO_AR_req_ptr_w]    =   TRAN_HP0_ARBURST; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_HP0_WREADY & TRAN_HP0_WVALID ) begin    // RTL is sending a WDATA data 
            FIFO_WDATA [FIFO_WDATA_req_ptr_w]    <=   TRAN_HP0_WDATA; 
            FIFO_WSTRB [FIFO_WDATA_req_ptr_w]    <=   TRAN_HP0_WSTRB; 
            if(FIFO_WDATA_req_ptr_w != FIFO_DEPTH - 1) 
                FIFO_WDATA_req_ptr_w <= FIFO_WDATA_req_ptr_w + 1; 
            else 
                FIFO_WDATA_req_ptr_w <= 0; 
            if (TRAN_HP0_WLAST == 1 ) begin
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_HP0_AWVALID && TRAN_HP0_AWREADY && (FIFO_AW_req_ptr_w == FIFO_DEPTH - 1)) 
          FIFO_AW_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_HP0_ARVALID && TRAN_HP0_ARREADY && (FIFO_AR_req_ptr_w == FIFO_DEPTH - 1)) 
          FIFO_AR_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_HP0_WVALID && TRAN_HP0_WREADY && (FIFO_WDATA_req_ptr_w == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if ( send_one_BRESP == 'b1 && !(BRESP_counter != 32'h0 && TRAN_HP0_BREADY) ) begin
            BRESP_counter <= BRESP_counter + 1;
        end    
        
        else if (send_one_BRESP != 'b1 && (BRESP_counter != 32'h0 && TRAN_HP0_BREADY)) begin
            BRESP_counter <= BRESP_counter - 1;
        end
    end
end
...
initial begin : AW_request_proc
    ...
    reg [HP0_DATA_BITWIDTH - 1 : 0] FIFO_WDATA_tmp;
    reg [HP0_DATA_BITWIDTH - 1 : 0] WDATA_tmp;
    reg [HP0_DATA_BITWIDTH/8 - 1 : 0] FIFO_WSTRB_tmp;
    @(posedge clk);
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > HP0_mem_depth) begin
                $display ("Write request address %d exceed AXI master HP0 array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, HP0_mem_depth); 
                $finish;
            end
                    ...
                    if (FIFO_WDATA_req_empty != 1) begin 
                        ...
                        for (i = 0 ; i < data_byte_size; i = i + 1) begin
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    WDATA_tmp[j] = HP0_mem [(FIFO_AW_req_transaction_tmp % mem_page_num) * HP0_mem_depth + FIFO_AW_req_ADDR_tmp/data_byte_size + counter][j];
                                end
                            end
                        end
                        HP0_mem [(FIFO_AW_req_transaction_tmp % mem_page_num) * HP0_mem_depth + FIFO_AW_req_ADDR_tmp/data_byte_size + counter] <= WDATA_tmp;
                    ...
                    if (FIFO_WDATA_req_empty != 1) begin 
                        ...
                        for (i = 0 ; i < data_byte_size; i = i + 1) begin
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    WDATA_tmp[j] = HP0_mem [(FIFO_AW_req_transaction_tmp % mem_page_num) * HP0_mem_depth + FIFO_AW_req_ADDR_tmp/data_byte_size][j];
                                end
                            end    
                        end
                        HP0_mem [(FIFO_AW_req_transaction_tmp % mem_page_num) * HP0_mem_depth + FIFO_AW_req_ADDR_tmp/data_byte_size] <= WDATA_tmp;
...
initial begin : AR_request_proc
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > HP0_mem_depth) begin
                $display ("Read request address %d exceed AXI master HP0 array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, HP0_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AR_req_BURST_tmp === 1) begin
                ...
                while (counter != input_length + 1) begin
                    RDATA_tmp <= HP0_mem [(FIFO_AR_req_transaction_tmp % mem_page_num) * HP0_mem_depth + FIFO_AR_req_ADDR_tmp/data_byte_size +   counter] ;
                    RVALID_tmp <= 1;
                    RRESP_tmp <= 0;
                    ...
                    @(posedge clk);
                    if (RVALID_tmp && TRAN_HP0_RREADY) begin
                        counter = counter + 1;
                    end 
                end
                RVALID_tmp <= 0;
                ...
                input_length = FIFO_AR_req_LEN_tmp;
                while (counter != input_length + 1) begin
                    RDATA_tmp <= HP0_mem [(FIFO_AR_req_transaction_tmp % mem_page_num) * HP0_mem_depth + FIFO_AR_req_ADDR_tmp/data_byte_size ] ;
                    RVALID_tmp <= 1;
                    RRESP_tmp <= 0;
                    RLAST_tmp <= 1;
                    @(posedge clk);
...
initial begin : read_file_process 
  ...
  integer mem_page; 
  integer base_page; 
  integer HP0_bitwidth; 
  reg [127 : 0] token; 
  reg [HP0_C_DATA_BITWIDTH - 1 : 0] token_tmp; 
  reg [HP0_DATA_BITWIDTH - 1 : 0] mem_tmp; 
  integer i; 
  transaction_num = 0;
  HP0_bitwidth = HP0_C_DATA_BITWIDTH; 
  count_seperate_factor_by_bitwidth (HP0_bitwidth , factor);
  fp = $fopen(`TV_IN_HP0,"r"); 
  if(fp == 0) begin                               // Failed to open file 
      $display("Failed to open file \"%s\"!", `TV_IN_HP0); 
      $finish; 
  end 
  read_token(fp, token); 
  ...
  while (token != "[[[/runtime]]]") begin 
      ...
      base_page = mem_page * HP0_mem_depth ;
      mem_tmp [HP0_DATA_BITWIDTH - 1: 0] = 0;
      for(i = 0; i < 784 ; i = i + 1) begin 
          ...
          if (factor == 4) begin
              ...
              if (i%factor == 3) begin
                  ...
                  HP0_mem[base_page + i/factor] = mem_tmp;
                  mem_tmp [HP0_DATA_BITWIDTH - 1 : 0] = 0;
              end
          end
          if (factor == 2) begin
