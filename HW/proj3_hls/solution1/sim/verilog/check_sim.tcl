...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.obj_detector.autotvin_HP0.dat"
         "c.obj_detector.autotvin_HP1.dat"
         "c.obj_detector.autotvin_HP2.dat"
         "c.obj_detector.autotvin_A.dat"
         "c.obj_detector.autotvin_W0.dat"
         "c.obj_detector.autotvin_W1.dat"
         "c.obj_detector.autotvin_res.dat"
         "c.obj_detector.autotvout_HP3.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.obj_detector.autotvout_HP3.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
