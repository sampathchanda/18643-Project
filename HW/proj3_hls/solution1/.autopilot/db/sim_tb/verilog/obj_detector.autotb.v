...
`define AUTOTB_TVIN_HP0  "./c.obj_detector.autotvin_HP0.dat"
`define AUTOTB_TVIN_HP1  "./c.obj_detector.autotvin_HP1.dat"
`define AUTOTB_TVIN_HP2  "./c.obj_detector.autotvin_HP2.dat"
`define AUTOTB_TVIN_A  "./c.obj_detector.autotvin_A.dat"
`define AUTOTB_TVIN_W0  "./c.obj_detector.autotvin_W0.dat"
`define AUTOTB_TVIN_W1  "./c.obj_detector.autotvin_W1.dat"
`define AUTOTB_TVIN_res  "./c.obj_detector.autotvin_res.dat"
`define AUTOTB_TVIN_HP0_out_wrapc  "./rtl.obj_detector.autotvin_HP0.dat"
`define AUTOTB_TVIN_HP1_out_wrapc  "./rtl.obj_detector.autotvin_HP1.dat"
`define AUTOTB_TVIN_HP2_out_wrapc  "./rtl.obj_detector.autotvin_HP2.dat"
`define AUTOTB_TVIN_A_out_wrapc  "./rtl.obj_detector.autotvin_A.dat"
`define AUTOTB_TVIN_W0_out_wrapc  "./rtl.obj_detector.autotvin_W0.dat"
`define AUTOTB_TVIN_W1_out_wrapc  "./rtl.obj_detector.autotvin_W1.dat"
`define AUTOTB_TVIN_res_out_wrapc  "./rtl.obj_detector.autotvin_res.dat"
`define AUTOTB_TVOUT_HP3  "./c.obj_detector.autotvout_HP3.dat"
`define AUTOTB_TVOUT_HP3_out_wrapc  "./impl_rtl.obj_detector.autotvout_HP3.dat"
