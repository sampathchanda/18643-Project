...
set Library     "hls"
set IPName      "obj_detector"
set Version     "1.0"
set DisplayName "Obj_detector"
set Revision    "1612032156"
set Description "An IP generated by Vivado HLS"
set Device      "zynq"
set Taxonomy    "/VIVADO_HLS_IP"

## Variables
set Top "obj_detector"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 A W 0x0 "Data signal of A" {{0 32 A W 0 "Bit 31 to 0 Data signal of A"}}} {0x18 W0 W 0x0 "Data signal of W0" {{0 32 W0 W 0 "Bit 31 to 0 Data signal of W0"}}} {0x20 W1 W 0x0 "Data signal of W1" {{0 32 W1 W 0 "Bit 31 to 0 Data signal of W1"}}} {0x28 res W 0x0 "Data signal of res" {{0 32 res W 0 "Bit 31 to 0 Data signal of res"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS s_axi_control m_axi_HP0 m_axi_HP1 m_axi_HP2 m_axi_HP3"
    }
    ap_rst_n {
        type "reset"
        polarity "ACTIVE_LOW"
    ...
    m_axi_HP0 {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_HP0"
        data_width "32"
        param_prefix "C_M_AXI_HP0"
        ...
        NUM_READ_OUTSTANDING "5"
        NUM_WRITE_OUTSTANDING "5"
    }
    m_axi_HP1 {
        type "native_axim"
        mode "master"
    ...
    m_axi_HP2 {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_HP2"
        data_width "32"
        param_prefix "C_M_AXI_HP2"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
...
## System Info
set user_parameters_list {clk_period 10.000000 machine 64 combinational 0 latency 38513 II x}
