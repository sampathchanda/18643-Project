...
set id 0
set name softmax_fadd_32ns_32ns_32_5_full_dsp
...
set id 1
set name softmax_fdiv_32ns_32ns_32_16
...
set id 2
set name softmax_fptrunc_64ns_32_1
...
set id 3
set name softmax_fpext_32ns_64_1
...
set id 4
set name softmax_dadd_64ns_64ns_64_5_full_dsp
...
set id 5
set name softmax_ddiv_64ns_64ns_64_31
...
set id 6
set name softmax_dexp_64ns_64ns_64_18_full_dsp
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 7 \
			corename softmax_control_axilite \
			name softmax_control_s_axi \
			ports {$port_control} \
			op interface \
		} "
	} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler softmax_control_s_axi
}
