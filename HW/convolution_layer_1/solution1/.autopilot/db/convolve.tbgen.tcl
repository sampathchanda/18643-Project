set C_TypeInfoList {{ 
"convolve" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"image": [[], {"reference": "0"}] }, {"weights": [[], {"array": [ {"scalar": "float"}, [25]]}] }, {"conv_output": [[], {"reference": "1"}] }, {"done": [[],{ "pointer":  {"scalar": "int"}}] }],[],""], 
...
set C_modelArgMapList {[ 
	{ "Name" : "image_V", "interface" : "fifo", "bitwidth" : 8 ,"direction" : "READONLY" ,"bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "image.V","cData": "unsigned char","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "conv_output_V", "interface" : "fifo", "bitwidth" : 32 ,"direction" : "WRITEONLY" ,"bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "conv_output.V","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	{ "Name" : "done", "interface" : "wire", "bitwidth" : 32 ,"direction" : "WRITEONLY" ,"bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "done","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} ]}
