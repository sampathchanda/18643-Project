...
module AESL_autofifo_conv_output_V (
    clk,
    reset,
    if_empty_n,
    if_read,
...
//------------------------Parameter----------------------
localparam
	TV_IN	=	"../tv/cdatafile/c.convolve.autotvin_conv_output_V.dat",
	TV_OUT	=	"../tv/rtldatafile/rtl.convolve.autotvout_conv_output_V.dat";

//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 32;
parameter ADDR_WIDTH = 32'd 11;
parameter DEPTH = 32'd 575;
