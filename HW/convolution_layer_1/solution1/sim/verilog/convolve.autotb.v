...
`define AUTOTB_TVIN_image_V_out_wrapc  "../tv/rtldatafile/rtl.convolve.autotvin_image_V.dat"
`define AUTOTB_TVIN_weights_out_wrapc  "../tv/rtldatafile/rtl.convolve.autotvin_weights.dat"
`define AUTOTB_TVIN_conv_output_V_out_wrapc  "../tv/rtldatafile/rtl.convolve.autotvin_conv_output_V.dat"
...
`define AUTOTB_TVOUT_conv_output_V_out_wrapc  "../tv/rtldatafile/rtl.convolve.autotvout_conv_output_V.dat"
`define AUTOTB_TVOUT_done_out_wrapc  "../tv/rtldatafile/rtl.convolve.autotvout_done.dat"
...
initial begin : proc_ap_c_n_tvin_image_V_trans_num
    ...
    integer size;
    reg [127 : 0] token;
    fp = $fopen("../tv/stream_size/stream_size_in_image_V.dat","r");
    if(fp == 0) begin       // Failed to open file
