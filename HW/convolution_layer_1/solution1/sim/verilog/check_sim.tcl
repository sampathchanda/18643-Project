...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.convolve.autotvin_image_V.dat"
         "c.convolve.autotvin_weights.dat"
         "c.convolve.autotvin_conv_output_V.dat"
         "c.convolve.autotvout_conv_output_V.dat"
         "c.convolve.autotvout_done.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.convolve.autotvout_conv_output_V.dat"
         "rtl.convolve.autotvout_done.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
