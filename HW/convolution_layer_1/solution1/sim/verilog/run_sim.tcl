...
if {[file isfile convolve.autotvin.dat]} {
    file delete -force convolve.autotvin.dat
}
if {[file isfile convolve.autotvout.dat]} {
    file delete -force convolve.autotvout.dat
}
