...
architecture behav of convolve is 
    ...
    "convolve,hls_ip_2015_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=1,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=8.528500,HLS_SYN_LAT=91882,HLS_SYN_TPT=91883,HLS_SYN_MEM=1,HLS_SYN_DSP=5,HLS_SYN_FF=3554,HLS_SYN_LUT=4128}";
    ...
    signal convolve_Loop_BUFFER_RESET_proc_U0_weights_address1 : STD_LOGIC_VECTOR (4 downto 0);
    signal convolve_Loop_BUFFER_RESET_proc_U0_weights_ce1 : STD_LOGIC;
    signal convolve_Loop_BUFFER_RESET_proc_U0_weights_q1 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    convolve_Loop_BUFFER_RESET_proc_U0_weights_q1 <= weights_q1;
