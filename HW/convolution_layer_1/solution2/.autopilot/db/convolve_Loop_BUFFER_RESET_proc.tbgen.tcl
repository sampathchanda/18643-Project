...
set Spec2ImplPortList { 
	...
	weights { ap_memory {  { weights_address0 mem_address 1 5 }  { weights_ce0 mem_ce 1 1 }  { weights_q0 mem_dout 0 32 }  { weights_address1 mem_address 1 5 }  { weights_ce1 mem_ce 1 1 }  { weights_q1 mem_dout 0 32 } } }
