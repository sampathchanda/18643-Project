; ModuleID = '/home/littlefoot/18643_project/Hardware-Accel/HW/convolution_layer_1/solution2/.autopilot/db/a.o.2.bc'
...
codeRepl:
  ...
  call void (...)* @_ssdm_op_SpecInterface(i8* %conv_output_V, [8 x i8]* @ap_fifo_str, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str29, [1 x i8]* @p_str29, [8 x i8]* @ap_fifo_str)
  call void (...)* @_ssdm_op_SpecInterface(i8* %image_V, [8 x i8]* @ap_fifo_str, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str28, [1 x i8]* @p_str28, [8 x i8]* @ap_fifo_str)
...
entry:
  ...
  %empty_11 = zext i23 %1 to i24
  %empty_12 = shl i24 %empty, 23
...
._crit_edge10:                                    ; preds = %2, %._crit_edge.0
  %empty_14 = call i32 (...)* @_ssdm_op_SpecRegionEnd([10 x i8]* @p_str4, i32 %tmp_2)
  br label %.preheader9
...
; <label>:2                                       ; preds = %._crit_edge.0
  ...
  call void @_ssdm_op_Write.ap_fifo.volatile.i8P(i8* %conv_output_V, i8 %result_V)
...
entry:
  ...
  %empty_17 = trunc i31 %empty to i8
  ret i8 %empty_17
}
...
entry:
  %empty = call i32 @llvm.part.select.i32(i32 %0, i32 %1, i32 %2)
  %empty_26 = trunc i32 %empty to i24
  ret i24 %empty_26
}
...
entry:
  %empty = call i32 @llvm.part.select.i32(i32 %0, i32 %1, i32 %2)
  %empty_27 = trunc i32 %empty to i30
  ret i30 %empty_27
}
