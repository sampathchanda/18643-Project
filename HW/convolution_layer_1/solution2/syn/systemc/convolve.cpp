...
convolve::convolve(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    convolve_Loop_BUFFER_RESET_proc_U0->weights_address1(convolve_Loop_BUFFER_RESET_proc_U0_weights_address1);
    convolve_Loop_BUFFER_RESET_proc_U0->weights_ce1(convolve_Loop_BUFFER_RESET_proc_U0_weights_ce1);
    convolve_Loop_BUFFER_RESET_proc_U0->weights_q1(convolve_Loop_BUFFER_RESET_proc_U0_weights_q1);
    ...
    SC_METHOD(thread_convolve_Loop_BUFFER_RESET_proc_U0_weights_q1);
    sensitive << ( weights_q1 );
    ...
    sensitive << ( convolve_Loop_BUFFER_RESET_proc_U0_weights_address1 );

    SC_METHOD(thread_weights_ce0);
    sensitive << ( convolve_Loop_BUFFER_RESET_proc_U0_weights_ce0 );

    SC_METHOD(thread_weights_ce1);
    sensitive << ( convolve_Loop_BUFFER_RESET_proc_U0_weights_ce1 );
    ...
    sc_trace(mVcdFile, convolve_Loop_BUFFER_RESET_proc_U0_weights_address1, "convolve_Loop_BUFFER_RESET_proc_U0_weights_address1");
    sc_trace(mVcdFile, convolve_Loop_BUFFER_RESET_proc_U0_weights_ce1, "convolve_Loop_BUFFER_RESET_proc_U0_weights_ce1");
    sc_trace(mVcdFile, convolve_Loop_BUFFER_RESET_proc_U0_weights_q1, "convolve_Loop_BUFFER_RESET_proc_U0_weights_q1");
...
void convolve::thread_convolve_Loop_BUFFER_RESET_proc_U0_weights_q1() {
    convolve_Loop_BUFFER_RESET_proc_U0_weights_q1 = weights_q1.read();
}
...
void convolve::thread_weights_address1() {
    weights_address1 = convolve_Loop_BUFFER_RESET_proc_U0_weights_address1.read();
}
...
void convolve::thread_weights_ce1() {
    weights_ce1 = convolve_Loop_BUFFER_RESET_proc_U0_weights_ce1.read();
}
