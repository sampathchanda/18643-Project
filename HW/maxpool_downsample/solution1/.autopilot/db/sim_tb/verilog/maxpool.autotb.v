...
`define AUTOTB_DUT      maxpool
`define AUTOTB_DUT_INST AESL_inst_maxpool
`define AUTOTB_TOP      apatb_maxpool_top
`define AUTOTB_LAT_RESULT_FILE "maxpool.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "maxpool.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_maxpool_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_TRANSACTION_NUM  1
`define AUTOTB_CLOCK_PERIOD 10.000000
`define LENGTH_input_V 576
`define LENGTH_output_V 144

`define   AESL_DEPTH_begin_r 0
...
`define   AESL_DEPTH_ok 0
`define AUTOTB_TVIN_input_V  "./c.maxpool.autotvin_input_V.dat"
`define AUTOTB_TVIN_output_V  "./c.maxpool.autotvin_output_V.dat"
`define AUTOTB_TVIN_input_V_out_wrapc  "./rtl.maxpool.autotvin_input_V.dat"
`define AUTOTB_TVIN_output_V_out_wrapc  "./rtl.maxpool.autotvin_output_V.dat"
`define AUTOTB_TVOUT_output_V  "./c.maxpool.autotvout_output_V.dat"
`define AUTOTB_TVOUT_output_V_out_wrapc  "./impl_rtl.maxpool.autotvout_output_V.dat"
...
// The signal of port ok
reg [0: 0] AESL_REG_ok = 0;
assign ok = AESL_REG_ok;
...
initial begin : generate_done_cnt_proc
    ...
    @(posedge AESL_clock);
    # 0.4;
    fp1 = $fopen("./rtl.maxpool.autotvout_output_V.dat", "r");
    fp2 = $fopen("./impl_rtl.maxpool.autotvout_output_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.maxpool.autotvout_output_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.maxpool.autotvout_output_V.dat\"!");
    else begin
        $display("Comparing rtl.maxpool.autotvout_output_V.dat with impl_rtl.maxpool.autotvout_output_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
...
initial begin : write_output_transactor_output_V_runtime_process
    integer fp;
...
always @ (posedge AESL_clock or posedge AESL_reset) begin
    ...
    begin
        ...
        if ( AESL_mLatCnterIn_addr > AESL_mLatCnterOut_addr ) begin
          if ( AESL_clk_counter - AESL_mLatCnterIn[AESL_mLatCnterOut_addr] > 10 * 579 ) begin
